...
// Hard assertions- fails and stops the execution of the test
    // use hard assertion when failure should halt the test execution.
// Soft assertions- fails but continues the execution of the test, and marks the test as failed at the end of the test execution.
    //use soft assertion when you want to verify multiple conditions independently. 
